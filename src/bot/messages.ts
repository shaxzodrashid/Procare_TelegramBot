...
const messages = {
  uz: {
    ...
    logoutFailed: 'Hozir tizimdan chiqib bo‘lmadi. Iltimos, keyinroq urinib ko‘ring.',
    commandStart: 'Botni boshlash yoki qayta boshlash',
  ...
  ru: {
    ...
    logoutFailed: 'Сейчас не удалось выйти из системы. Попробуйте позже.',
    commandStart: 'Начать или перезапустить бота',
