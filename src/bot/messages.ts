...
const messages = {
  uz: {
    ...
    adminClientSearchPrompt: '🔍 Mijozning ismi, familiyasi, username yoki telefon raqamini yozib yuboring (masalan: Ali yoki +998...):',
    adminClientListTitle: '👥 Topilgan mijozlar:',
    adminClientNotFound: '🔎 Mos mijoz topilmadi.',
    adminClientSearchFailed: '⚠️ Qidiruvda xatolik yuz berdi. Iltimos, keyinroq qayta urinib ko‘ring.',
    ...
    adminClientTemplatePlaceholderPrompt: 'Iltimos, shablon uchun <b>{{key}}</b> qiymatini kiriting:',
  ...
  ru: {
    ...
    adminClientSearchPrompt: '🔍 Введите имя, фамилию, username или номер телефона клиента (например: Ali или +998...):',
    ...
    adminClientTemplatePlaceholderPrompt: 'Пожалуйста, введите значение для <b>{{key}}</b> для шаблона:',
    ...
    adminClientMessageFailed: '⚠️ Не удалось отправить сообщение. Возможно, клиент заблокировал бота.',
