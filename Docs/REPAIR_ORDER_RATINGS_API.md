...
| ------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `grade` | Yes      | integer | Customer grade from `1` (lowest) through `10` (highest).                                                                                 |
...
| `grade`           | Persisted integer grade from 1 through 10.                                 |
...
{
  "statusCode": 400,
  "message": "Grade must not be greater than 10",
...
| `400`  | `grade`                    | `grade` is missing, not an integer, less than 1, or greater than 10.      | Send one integer from 1 through 10.                                                 |
...
| `grade`                    | Required small integer constrained by the database to `1` through `10`.                                        |
